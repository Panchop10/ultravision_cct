...
public class RentalModel {
     ...
     * @return ArrayList of Rentals in the database.
     */
    public static ArrayList<Rental> findNotReturned(){
        ArrayList<Rental> listRentals = new ArrayList<Rental>();
    ...
    public static void returnTitle(int itemID, int status, int fine){
        //query to insert rental item data
    ...
    public static ArrayList<ArrayList> getItemStatus() {
        //query to bring all the item type
        String query = "SELECT * FROM rental_status;";
    ...
    public static ArrayList<ArrayList> getStatusId(String status) {
        //query to bring all the item type
        String query = "SELECT * FROM rental_status WHERE name = '"+status+"';";
